  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_end: cn('bg-gray-800 rounded-r-md', defaultClassNames.range_end),
        today: cn(
          'bg-gray-600 text-white rounded-md data-[selected=true]:rounded-none',
