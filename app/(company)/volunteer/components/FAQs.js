...
const faqs = [
  ...
  {
    q: 'Is Good Party a political party?',
  ...
  {
    q: "There aren't currently any Good Party Certified candidates running in my area. Can I still get involved?",
  ...
  },
  {
    ...
    a: "Whoever you want! Good Party has a wide range of candidates, and while it's unlikely that you'll agree with all of them, there will certainly be those you are inspired by and will want to support. Occasionally, we also spotlight specific candidates who need your help. If you want to see more people-powered candidates who you agree with get elected, they need your help! The two parties have big money on their side, but we've got the party!",
  },
  {
  ...
  },
  {
    ...
    a: "Yes! Members of our community proudly wear Good Party swag, and we've got some seriously cute items to add to your wardrobe. As you continue to deepen your involvement as a volunteer, there are more opportunities for free swag!",
  },
  {
    q: 'Do I need any relevant experience or skills to get involved?',
    a: "Not at all. We understand that getting involved in the political world can be intimidating and feel very gatekeep-y. Good Party is actually the ideal place for someone tiptoeing into civic engagement for the first time, and we'll make you feel welcome.",
  },
  {
  ...
  },
  {
    ...
    a: "Not here! Good Party was created exactly because politics is so messed up and unrewarding. We are all about bringing the party to politics and not just talking about things but actually creating results and growing our movement. We're here to change politics, for good and want to have fun doing it!",
  },
  {
    q: 'Can I do in-person actions like talking to voters at local concerts, trivia nights, and knocking on doors?',
    a: 'If Good Party Certified candidates are running in your area, we will have IRL events and opportunities for you to get involved! Check out our list of candidates here to find out if any are running in your neck of the woods.',
  },
  {
    q: "I have more questions that aren't answered here! Who can answer them?",
    a: 'Grab a drink with us, and a full-time team member will get your questions answered! Sign up here to grab a virtual drink with one of our community leaders. These are full-time members of our team who know everything there is to know about Good Party and the best ways to get you plugged in!',
  },
];

export default function FAQs() {
  return (
    <section className=" bg-indigo-200 pb-12 pt-12 md:mt-0">
      <MaxWidth>
