...
export default function ElectionDates(props) {
  return (
    <>
      <div className="grid grid-cols-12 md:justify-items-center pt-10 bg-indigo-800">
        <div className="col-span-12 lg:col-span-8 p-10 w-full">
          <div className="flex flex-col w-full h-auto border-slate-50 border-[2px] rounded-2xl p-10">
            ...
            <div className="flex w-full h-auto mt-5 text-slate-50 text-lg items-center">
              7/10
              <span className="ml-3">Early voting registration</span>
            </div>
            <div className="flex w-full h-auto mt-5 text-slate-50 text-lg items-center">
              10/10
              <span className="ml-3">Municipal primary election</span>
            </div>
            <div className="flex w-full h-auto mt-5 text-slate-50 text-lg items-center">
              11/7
              <span className="ml-3">General election</span>
            </div>
          </div>
        </div>
