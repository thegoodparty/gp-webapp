  ...
  return (
    <div className="p-4 border-y border-slate-300">
      ...
      <div className="flex items-center mb-4">
        {gender && (
          <div className="text-xs font-medium text-indigo-300 flex items-center bg-slate-50 rounded py-1 px-2 mr-2">
            <MdOutlineFemale />
        ...
        {party && party !== '' && (
          <div className="text-xs font-medium text-indigo-300 flex items-center bg-slate-50 rounded py-1 px-2 mr-2 uppercase">
            <IoPersonSharp />
