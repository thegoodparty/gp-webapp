...
export default function ElectionHero(props) {
  ...
  return (
    <>
      <MaxWidth>
        <div className="grid grid-cols-12 gap-3 md:justify-items-center pt-10 bg-indigo-50 items-stretch">
      ...
      {city === 'nashville' ? (
        <div className="bg-[linear-gradient(-172deg,_#F9FAFB_54.5%,_#0D1528_55%)] h-[calc(100vw*.17)] w-full -mt-[calc(100vw*.17)]" />
      ) : (
        <div className="bg-[linear-gradient(172deg,_#F9FAFB_54.5%,_#0D1528_55%)] h-[calc(100vw*.17)] w-full -mt-[calc(100vw*.17)]" />
      )}
    </>
