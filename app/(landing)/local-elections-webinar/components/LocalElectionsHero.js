...
const LocalElectionsHero = () => {
  return (
    <section className="">
      <div className="grid grid-cols-12 m-4 bg-gray-200 rounded-3xl px-4 py-10 lg:m-8 lg:px-20 lg:py-36">
        <div className="col-span-12 lg:col-span-5">
          <h5 className="uppercase text-tertiary text-sm font-bold leading-6 tracking-widest">
            May 7th at 5pm MST
          </h5>
          <h1 className="text-5xl lg:text-7xl font-semibold leading-none my-4">
            Webinar: Path <br />
            to Victory
          </h1>
          ...
          <h6>
            ...
            <Image
              ...
              alt="FWD Party Logo"
            />
            <span className="uppercase font-semibold text-sm align-middle lg:text-2xl">
              Forward Party
            </span>
          </h6>
        </div>
