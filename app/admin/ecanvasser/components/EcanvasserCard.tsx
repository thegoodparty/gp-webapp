...
interface EcanvasserCardProps {
  ecanvasser: Ecanvasser
  onUpdate: () => void
}

const deleteEcanvasser = async (campaignId: number) => {
  const payload = {
    campaignId,
  }
...
export default function EcanvasserCard({
  ecanvasser,
  onUpdate,
}: EcanvasserCardProps): React.JSX.Element {
