...
export const personElectMessageText = ({ name, office }: Omit<MessageTextParams, 'constituentName'>): string => {
...
export const demoMessageText = ({ name, office, constituentName = 'Bill' }: MessageTextParams): string => {
...
export const messageText = ({ name, office }: Omit<MessageTextParams, 'constituentName'>): string => {
