...
export default async function BriefingChromeLayout({
  ...
  return (
    <DashboardLayout
      ...
      wrapperClassName="!p-0"
    >
      <AnnotationsScope meetingDate={slug} items={briefing.items}>
          ...
          <div className="flex min-h-full flex-col bg-muted pb-20 lg:h-svh lg:min-h-0 lg:overflow-hidden lg:pb-20">
            ...
            <div className="mx-auto w-full max-w-[1120px] px-4 py-6 lg:flex lg:min-h-0 lg:flex-1 lg:flex-col lg:overflow-hidden lg:px-8">
              <div className="lg:flex lg:min-h-0 lg:flex-1 lg:items-stretch lg:gap-8 lg:overflow-hidden">
                <aside className="hidden rounded-2xl border border-border bg-card p-3 lg:block lg:w-[260px] lg:shrink-0 lg:overflow-y-auto lg:scroll-pb-4">
                ...
                <div
                  ...
                  // WebkitTouchCallout suppresses iOS's long-press Copy/Look
                  // Up/Translate callout so only our HighlightToolbar shows
                  // on selection. Android has no equivalent web API; its
                  // floating selection action bar still appears.
                  style={{ WebkitTouchCallout: 'none' }}
                  className="flex flex-col gap-4 lg:min-h-0 lg:flex-1 lg:overflow-y-auto lg:scroll-pb-4"
                >
                  {children}
                </div>
              </div>
