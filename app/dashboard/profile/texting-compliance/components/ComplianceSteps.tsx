import ComplianceStep from 'app/dashboard/profile/texting-compliance/components/ComplianceStep'
...
const getSteps = (
  ...
  return [
    ...
    },
    {
      ...
      route: '/dashboard/profile/texting-compliance/register',
    ...
    },
    {
      ...
      route: '/dashboard/profile/texting-compliance/submit-pin',
