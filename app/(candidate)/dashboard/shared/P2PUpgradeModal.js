...
export function P2PUpgradeModal({
  ...
  const isProFreeTextsNonCompliant = variant === P2P_MODAL_VARIANTS.ProFreeTextsNonCompliant
  
  const content = isProFreeTextsNonCompliant ? {
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
            ...
            <div className="order-1 lg:order-1 space-y-3">
              ...
              {content.highlight && (
                <Body2 className="text-blue !font-bold mt-2">{content.highlight}</Body2>
              )}
            </div>
            ...
            <div className="order-2 lg:order-2 relative">
              <div className="relative w-full aspect-[3/2] lg:aspect-[4/3] rounded-lg overflow-hidden">
                <Image
                  ...
                  fill
                  className={content.image.includes('features.png') ? "object-contain" : "object-cover"}
