...
interface CommitteeCheckPageProps {
  campaign?: CampaignData
  user?: User | null
}

const CommitteeCheckPage = ({
  campaign = { details: {} },
}: CommitteeCheckPageProps): React.JSX.Element => {
  ...
  const onCampaignCommitteeBlur = () => doEinCheck()
