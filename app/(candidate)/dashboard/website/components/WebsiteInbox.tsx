...
import { WebsiteContact } from 'helpers/types'
...
interface ContactColumn {
  header: string
  accessorKey: keyof WebsiteContact
...
export default function WebsiteInbox(): React.JSX.Element {
  ...
  const [modalContact, setModalContact] = useState<WebsiteContact | null>(null)
  ...
  function handleRowClick(row: WebsiteContact): void {
    setModalContact(row)
  }
