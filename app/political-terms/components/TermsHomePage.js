        ...
        <div className="grid grid-cols-12 gap-3">
          <div className="col-span-12 lg:col-span-9">
            ...
            <div className="text-lg">
              Good Party's Terms Glossary is a list of definitions of words from
              the political and elections world. These terms are from an
              independent's perspective with an eye toward reform. If you have a
              suggestion for a new definition, send it to{' '}
              <a
