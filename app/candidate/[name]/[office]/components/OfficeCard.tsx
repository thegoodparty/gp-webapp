...
type ExtendedCandidate = Campaign & {
...
export default function OfficeCard(): React.JSX.Element {
  const [candidateBase] = usePublicCandidate()
  const candidate: ExtendedCandidate | null = candidateBase
