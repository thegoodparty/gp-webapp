...
export class AuthHelper {
  static async loginAsUser(page: Page, credentials: UserCredentials): Promise<void> {
    ...
    await page.getByPlaceholder("Please don't use your dog's").fill(credentials.password); // More specific password field locator
