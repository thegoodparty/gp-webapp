...
module.exports = async () => {
  ...
  let testCaseIds = [
    ...
    // Core functionality
    TEST_IDS.REGISTRATION_FLOW, TEST_IDS.LOGIN_FLOW, TEST_IDS.INVALID_LOGIN_ERROR_MESSAGE, 
    ...
    TEST_IDS.VOTER_OUTREACH, TEST_IDS.NEW_VOTER_OUTREACH,
    // API and other
    TEST_IDS.MAIN_API_HEALTH_CHECK, TEST_IDS.SITEMAP_ACCESSIBILITY, TEST_IDS.STATE_SITEMAP_URLS, 
    TEST_IDS.URL_LASTMODE_DATES,
  ];
