declare module 'csv-writer' {
  ...
  export function createObjectCsvWriter<
    T extends object = Partial<
      Record<string, string | number | boolean | null>
    >,
  >(params: CreateObjectCsvWriterParams): CsvWriter<T>

  export function createArrayCsvWriter<
    T extends Array<string | number | boolean | null> = Array<
      string | number | boolean | null
    >,
  >(params: CreateArrayCsvWriterParams): CsvWriter<T>

  export function createObjectCsvStringifier<
    T extends object = Partial<
      Record<string, string | number | boolean | null>
    >,
  >(params: CreateObjectCsvStringifierParams): CsvStringifier<T>

  export function createArrayCsvStringifier<
    T extends Array<string | number | boolean | null> = Array<
      string | number | boolean | null
    >,
  >(params: CreateArrayCsvStringifierParams): CsvStringifier<T>
}
